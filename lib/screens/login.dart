...
class AuthPage extends StatelessWidget {
  ...
  final TextEditingController _idController = TextEditingController(text: "@hknu.ac.kr");

  final focusNode = FocusNode();

  @override
  Widget build(BuildContext context) {
    _idController.selection = TextSelection.fromPosition(TextPosition(offset: -1));
  ...
  void _login(BuildContext context) async {
    try {
      var result = await FirebaseAuth.instance.signInWithEmailAndPassword(
          email: _idController.text.trim(), password: _passwordController.text.trim());
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                          ...
                          validator: (String value) {
                            if (value.isEmpty || value == '@hknu.ac.kr') {
                              //return "이메일을 입력해주세요.";
                              showDialog(
                                context: context,
                                builder: (BuildContext context) {
